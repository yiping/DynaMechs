...
macro( wx_find_root )
    ...
    if( ${wxWidgets_FIND_STYLE} STREQUAL "UNIX_STYLE_FIND" )
        ...
        #  )
        message(STATUS "---> ${s_wxWidgets_ROOT_DIR}")
		...
		wx_find_defaultconfig(s_wxWidgets_ROOT_DIR)
    endif()       
...
if( ${wxWidgets_FIND_STYLE} STREQUAL "WIN32_STYLE_FIND" )
    ...
    macro(WX_FIND_LIBS p_unv p_ucd p_dbg)
        ...
        foreach(LIB png tiff jpeg zlib regex expat scintilla )
        ...
        foreach( LIB core adv aui html media xrc dbgrid  propgrid gl qa stc richtext gizmos things netutils gizmos_xrc )
            set( WX_${LIB}${p_dbg} "WX_${LIB}${p_dbg}-NOTFOUND" CACHE FILEPATH "Cleared." FORCE)            
            find_library(WX_${LIB}${p_dbg}
                NAMES
...
if (wxWidgets_FOUND)
    if(NOT wxWidgets_FIND_QUIETLY)
		message(STATUS "wxWidgets_FIND_STYLE is ${wxWidgets_FIND_STYLE}")
		message(STATUS "wxWidgets_CONFIG_EXECUTABLE is ${wxWidgets_CONFIG_EXECUTABLE}")
