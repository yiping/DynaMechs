...
addpath dynamics
    ...
    function output = periodResidual(params)
        ...
        dynParams.CoPInitOffset = [-footLength/2 0 0];
        dynParams.CoPVel        = [footLength/tStanceDes 0 0];
    ...
    fprintf(1,'thisStep.footLength = \t%f;\n',footLength);
    fprintf(1,'thisStep.CoPInitOffset = \t%f;\n',dynParams.CoPInitOffset(1));
    fprintf(1,'thisStep.CoPVel    = \t%f;\n',dynParams.CoPVel(1));
