function hop()
    ...
    [Js_nss Ju_nss] = evalJacobian(stateInit, nonssParams, dynParams);
    K_nss = - Ju_nss\Js_nss;
    
    
    global ssResult
    
    ssParams = [ssResult(1) 0 ssResult(2) ssResult(2)];
    ssInit = [ssResult(3) 3.5 ssResult(4)]';
