/*****************************************************************************
 *     File: wxDMGLPolarCamera_yup.cpp
 *   Author: 
 *  Created: Jun 12, 2012
 *  Summary:
 *****************************************************************************/
...
#include "wxDMGLPolarCamera_yup.hpp"


wxDMGLPolarCamera_yup::wxDMGLPolarCamera_yup() :
      wxDMGLPolarCamera()
{
}


void wxDMGLPolarCamera_yup::spinScene(int delta[2], int button)
{
...
void wxDMGLPolarCamera_yup::applyView()
{
